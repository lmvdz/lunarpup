...
A course-readability follow-up moved the spawn outside gate one and raised every ring above its generated terrain height; two rings had been partially or fully underground. Rings now face their incoming route. The active gate uses a solid amber double-ring and downward beacon while future gates remain thin blue wireframes. The HUD supplies a steering-relative arrow and distance, and the minimap draws a connected diamond for the next gate. Automated browser driving reaches all four gates in order before beginning lap two.
